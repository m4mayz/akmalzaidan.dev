...
export async function ArticlesIndexPage({ locale }: { locale: Locale }) {
  ...
  return (
    <>
      ...
      <main className="relative z-10 px-5 pt-32 md:px-10 md:pt-35">
        <section className="mx-auto max-w-358" data-reveal>
          <h1 className="max-w-245 font-heading text-4xl font-light leading-[1.02] tracking-tighter text-foreground md:text-[92px]">
            {isIndonesian
          ...
          <p className="mt-8 max-w-160 text-[16px] leading-[1.6] text-muted-foreground md:text-[17px]">
            {isIndonesian
