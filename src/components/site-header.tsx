  ...
  useEffect(() => {
    ...
    const handleOutsideClick = (e: MouseEvent) => {
      ...
      if (
        ...
        !target.closest(".mobile-lang-dropdown-container")
      ) {
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <div className="flex gap-2">
              <div className="relative lang-dropdown-container">
                ...
                {isLangDropdownOpen && (
                  <div className="absolute right-0 mt-1.5 w-24 rounded-2xl border border-white/14 bg-background/90 backdrop-blur-md p-1 shadow-2xl z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                    <Link
                      className={cn(
          ...
          <nav className="flex flex-col gap-2">
            ...
            >
              ...
              <div className="relative mobile-lang-dropdown-container">
                ...
                {isMobileLangDropdownOpen && (
                  <div className="absolute left-0 bottom-full mb-2 w-32 rounded-2xl border border-white/14 bg-background/95 backdrop-blur-md p-1 shadow-2xl z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
                    <Link
                      className={cn(
