    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border pb-5">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">work / bilingual</p>
        </div>
              ...
              <div className="grid gap-3 border border-border p-4" key={locale}>
                ...
                <Area
                  ...
                  onChange={(value) => {
                    const sections = [...item[locale].sections];
                    if (index === -1)
                      sections.push({ ...section, body: splitParagraphs(value) });
                    else sections[index] = { ...section, body: splitParagraphs(value) };
                    onLocaleChange(locale, { sections });
                  }}
      ...
      <CmsGalleryEditor
        ...
        onGalleryChange={(locale, gallery) => onLocaleChange(locale, { gallery })}
        onUpload={onUpload}
      />
    </div>
  );
